...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "PICKING_ACTIONS_UK1" ON "PICKING_ACTIONS" ("LINE_ID")
  ;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "PICKING_ACTIONS" ADD CONSTRAINT "PICKING_ACTIONS_UK1" UNIQUE ("LINE_ID") ENABLE;
...
CREATE SEQUENCE "STOCK_SEQ" MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER NOCYCLE;
...
CREATE UNIQUE INDEX "STOCK_PK" ON "STOCK" ("ID");
--------------------------------------------------------
--  Constraints for Table STOCK
--------------------------------------------------------

ALTER TABLE "STOCK" ADD CONSTRAINT "STOCK_PK" PRIMARY KEY ("ID") ENABLE;
ALTER TABLE "STOCK" MODIFY ("QUANTITY" NOT NULL ENABLE);
ALTER TABLE "STOCK" MODIFY ("ITEM" NOT NULL ENABLE);
ALTER TABLE "STOCK" MODIFY ("ID" NOT NULL ENABLE);
--------------------------------------------------------
--  Ref Constraints for Table STOCK
--------------------------------------------------------

ALTER TABLE "STOCK" ADD CONSTRAINT "STOCK_FK1" FOREIGN KEY ("ITEM")
REFERENCES "ITEM" ("ID") ENABLE;
ALTER TABLE "STOCK" ADD CONSTRAINT "STOCK_FK2" FOREIGN KEY ("LOCATION")
REFERENCES "LOCATIONS" ("ID") ENABLE;
ALTER TABLE "STOCK" ADD CONSTRAINT "STOCK_FK4" FOREIGN KEY ("CONTAINER")
REFERENCES "CONTAINER" ("ID") ENABLE;
--------------------------------------------------------
...
FOR EACH ROW
  ...
  END;
/
ALTER TRIGGER "STOCK_TRG" ENABLE;
...
ALTER TABLE LOCATE_ACTIONS
MODIFY (PICKER_ID NULL);
...
--------------------------------------------------------
--  DDL for Sequence ORDERS_CODE_SEQ
--------------------------------------------------------

CREATE SEQUENCE "ORDERS_CODE_SEQ" MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER NOCYCLE;
  ...
  BEGIN
    ...
    BEGIN
      ...
      THEN
        ...
        INTO :NEW.ID
        FROM SYS.DUAL;
        SELECT ORDERS_CODE_SEQ.NEXTVAL
        INTO :NEW.CODE
        FROM SYS.DUAL;
      END IF;
