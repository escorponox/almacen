...
CREATE UNIQUE INDEX "PROYECTO"."ITEM_PK" ON "PROYECTO"."ITEM" ("ID")
...
ALTER TABLE "PROYECTO"."ITEM" ADD CONSTRAINT "ITEM_PK" PRIMARY KEY ("ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255
  STORAGE (INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "USERS" ENABLE;
ALTER TABLE "PROYECTO"."ITEM" MODIFY ("PRICE" NOT NULL ENABLE);
ALTER TABLE "PROYECTO"."ITEM" MODIFY ("NAME" NOT NULL ENABLE);
ALTER TABLE "PROYECTO"."ITEM" MODIFY ("CODE" NOT NULL ENABLE);
ALTER TABLE "PROYECTO"."ITEM" MODIFY ("ID" NOT NULL ENABLE);
--------------------------------------------------------
--  DDL for Trigger ITEM_TRG
--------------------------------------------------------

CREATE OR REPLACE TRIGGER "PROYECTO"."ITEM_TRG"
...
FOR EACH ROW
  ...
  END;
/
ALTER TRIGGER "PROYECTO"."ITEM_TRG" ENABLE;

--------------------------------------------------------
--  DDL for Table DB_VERSION
--------------------------------------------------------

CREATE TABLE "PROYECTO"."DB_VERSION"
(
...
CREATE UNIQUE INDEX "PROYECTO"."VERSION_PK" ON "PROYECTO"."DB_VERSION" ("VERSION")
PCTFREE 10 INITRANS 2 MAXTRANS 255
STORAGE ( INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT )
TABLESPACE "USERS";
...
ALTER TABLE "PROYECTO"."DB_VERSION" ADD CONSTRAINT "VERSION_PK" PRIMARY KEY ("VERSION")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255
  STORAGE (INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "USERS" ENABLE;
ALTER TABLE "PROYECTO"."DB_VERSION" MODIFY ("VERSION" NOT NULL ENABLE);
