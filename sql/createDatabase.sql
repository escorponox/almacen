...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "RECEIPT_ACTIONS_UK1" ON "RECEIPT_ACTIONS" ("REC_ORDER_ID", "REC_ORDER_LINE_ID", "DELIVERY_NOTE")
  ;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "RECEIPT_ACTIONS" ADD CONSTRAINT "RECEIPT_ACTIONS_UK1" UNIQUE ("REC_ORDER_ID", "REC_ORDER_LINE_ID", "DELIVERY_NOTE") ENABLE;
...
--------------------------------------------------------
  ...
  ALTER TABLE "RECEIPT_ACTIONS" ADD CONSTRAINT "RECEIPT_ACTIONS_FK1" FOREIGN KEY ("REC_ORDER_ID")
